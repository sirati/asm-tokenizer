...
def create_http_session() -> requests.Session:
    ...
    # crates.io rejects the default `python-requests/*` User-Agent with HTTP
    # 403 (rust-lang/crates.io#13482). Set an identifying UA per crates.io's
    # documented policy, matching nixpkgs PR #512735's fetch-cargo-vendor fix.
