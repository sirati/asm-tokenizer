"""Asm-binary filename-format helpers, vendored out of the framework
in commit 6c65bb7. Owns the regex-based parser for the standard
`platform-compiler-version-opt_binaryname` filename schema. The
framework retains TaskInfo / BinaryIdentifier / format_size as
generic types; we re-export them here so consumers have a single
import surface."""
import re
from dataclasses import dataclass
from pathlib import Path

from dynamic_runner._shared import BinaryIdentifier, TaskInfo, format_size
